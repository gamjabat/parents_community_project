...
public class MypageBoardListServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<Board> myBoards = new BoardService().selectBoardAllByMemberNo(param);
		
		session.setAttribute("myBoards", myBoards);
		
		// pageBar 생성하기
				int totalData = new BoardService().selectBoardAllByMemberNoCount(loginMember.getMemberNo());
