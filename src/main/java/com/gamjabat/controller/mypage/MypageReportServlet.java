 ...
 */
@WebServlet(name = "MypageReportServlet" , urlPatterns = {"/member/mypagereport.do"})
public class MypageReportServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MypageReportServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<Report> myReports = new ReportService().selectReportAllByMemberNo(param);
		
		session.setAttribute("myReports", myReports);
		
		// pageBar 생성하기
		int totalData = new ReportService().selectReportAllByMemberNoCount(loginMember.getMemberNo());
		...
		request.getRequestDispatcher("/WEB-INF/views/member/mypageReport.jsp")
