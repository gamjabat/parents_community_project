 ...
 */
@WebServlet(name = "MypageCommentServlet" , urlPatterns = {"/member/mypagecomment.do"})
public class MypageCommentServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<BoardComments> myComments = new BoardService().selectCommentsAllByMemberNo(param);
		
		session.setAttribute("myComments", myComments);
		
		// pageBar 생성하기
		int totalData = new BoardService().selectCommentsAllByMemberNoCount(loginMember.getMemberNo());
		...
		request.getRequestDispatcher("/WEB-INF/views/member/mypageComment.jsp")
